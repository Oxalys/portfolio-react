    ...
    return(
        ...
        <div id="services" className="container my-4 text-center">
            <div className="row py-4 align-items-center">
                ...
                <div className="icon">
                    <FontAwesomeIcon icon={faMagic} color="#472D7F" className="h1" />
                </div>
                <h3 className="py-3">Web Design</h3>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Molestias id volume amet.</p></div>
                <div className="col-md-3 col-sm-6 col-xs-12">
                <FontAwesomeIcon icon={faLaptopCode} color="#472D7F" className="h1 icon" />                    
                <h3 className="py-3">Web Dev</h3>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Molestias id volume amet.</p></div>
                <div className="col-md-3 col-sm-6 col-xs-12">
                <FontAwesomeIcon icon={faMobileAlt} color="#472D7F" className="h1 icon" />                    
                <h3 className="py-3">App Dev</h3>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Molestias id volume amet.</p></div>
                <div className="col-md-3 col-sm-6 col-xs-12">
                <FontAwesomeIcon icon={faSearch} color="#472D7F" className="h1 icon" />                    
